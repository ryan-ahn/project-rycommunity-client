<template>
  <section class="stack-wrapper">
    ...
    <div class="content-box">
      <p>{{ description }}</p>
      <img
        src="/images/complete-createlab.png"
        alt="thumbnail"
      >
      <AtomsButtonMainLine
        :type="buttonType"
...
// State
const title = CONTENT_POPUP.complete.joinLab.title;
const description = CONTENT_POPUP.complete.joinLab.description;
const buttonType = BUTTON_MAIN_FILL.complete.joinLab.type;
const buttonText = BUTTON_MAIN_FILL.complete.joinLab.text;
// Functions
